...
<html lang="it-IT" data-lt-installed="true">
  <head>
    ...
    />
    <title>Termini e Condizioni - EasySubscribe</title>
  </head>
  <body>
      ...
      <section id="login-btn" class="mx-auto">
        <div class="row">
          <div class="col-12 fade-in" style="margin-bottom: -30px">
            <h1>Termini e <span class="color-header">Condizioni</span></h1>
        ...
        <div class="card" id="card">
            <div class="m-4">
                <div id="terms-and-conditions" class="terms">
                  <p>Le presenti Condizioni Generali di Abbonamento (le “Condizioni Generali”) regolano la sottoscrizione di piani di abbonamenti (gli “Abbonamenti”) eventi partner (gli “Eventi Partner”) sul sito internet https://stripe.com/ (il “Sito”) , fruibili partecipando ai suddetti eventi partner.</p>
                  ...
                  <h2>Ambito di applicazione delle condizioni generali</h2>
                  ...
                  <h2>Modifiche alle Condizioni Generali</h2>
                  ...
                  <h2>Sottoscrizione di un Abbonamento</h2>
                  ...
                  <h2>Durata e rinnovo dell’Abbonamento</h2>
